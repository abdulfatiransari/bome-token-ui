...
// import { ConnectWallet, SolanaLogo } from "components";
...
//     const [metadataCollectionPDA, _bump] = PublicKey.findProgramAddressSync(
//       [seed1, seed2, seed3],
//       PROGRAM_ID
//     );
//     const [masterEditionCollectionPDA, _bump2] =
...
//             const [metadataItemPDA, _bump] = PublicKey.findProgramAddressSync(
//               [seed1, seed2, seed5],
//               PROGRAM_ID
//             );

//             // get the NFT object of the NFT to add in the new collection in order to know if it is already in a collection
//             const NFTToAdd = await metaplex
//               .nfts()
//               .findByMint({ mintAddress: NFTMintPubkey });
...
//               const oldCollectionNFT = await metaplex
//                 .nfts()
//                 .findByMint({ mintAddress: oldCollection });
...
//               const [masterEditionOldCollectionPDA, _bump2] =
//                 PublicKey.findProgramAddressSync(
//                   [seed1, seed2, seed6, seed4],
//                   PROGRAM_ID
//                 );
//               const [metadataOldCollectionPDA, _bump3] =
//                 PublicKey.findProgramAddressSync(
//                   [seed1, seed2, seed6],
//                   PROGRAM_ID
//                 );
...
//                         <button className="text-white m-2 font-semibold bg-[#343e4f] md:w-[280px] rounded-full shadow-xl border">
//                           Use an existing NFT
//                         </button>
//                       ) : (
//                         <button
//                           className="text-white m-2 font-semibold bg-[#667182] md:w-[280px] rounded-full shadow-xl border"
//                           onClick={() => {
//                             setCreateMethod("existing"), resetCollectionNFT();
//                           }}
//                         >
//                           Use an existing NFT
//                         </button>
//                       )}
//                       {createMethod == "create" ? (
//                         <button className="text-white m-2 font-semibold bg-[#343e4f] md:w-[300px] rounded-full shadow-xl border">
//                           Create the Collection NFT
//                         </button>
//                       ) : (
//                         <button
//                           className="text-white m-2 font-semibold bg-[#667182] md:w-[300px] rounded-full shadow-xl border"
//                           onClick={() => {
//                             setCreateMethod("create"), setCollectionNFTMint("");
//                           }}
//                         >
//                           Create the Collection NFT
//                         </button>
...
//                             onChange={(e) =>
//                               setCollectionNFTMint(e.target.value)
//                             }
//                           />
//                         </div>
//                       </div>
...
//                         </div>
//                         <div>
//                           <label className="underline my-2 flex font-bold">
//                             Logo
//                           </label>
//                           <label
//                             htmlFor="file"
//                             className="text-white font-semibold  shadow-xl bg-[#414e63] border px-2 py-1 h-[40px] uppercase hover:bg-[#2C3B52] hover:cursor-pointer"
//                           >
//                             Upload Logo
//                             <input
//                               id="file"
...
//                           </label>
//                           {collectionFileName != "" && (
//                             <div className="mt-2">{collectionFileName}</div>
//                           )}
//                         </div>
//                       </div>
//                     )}
...
//                         {" "}
//                         Add individual NFTs or import a CSV file to migrate them
//                         to your Collection.
//                       </div>
...
//                             className="text-white m-2 font-semibold bg-[#667182] md:w-[300px] rounded-full shadow-xl border"
//                             onClick={() => {
//                               setAddItemMethod("csv"),
//                                 setNFTMintList([{ NFT_mint: "" }]);
//                             }}
//                           >
//                             Use csv File
//                           </button>
...
//                                     value={x.NFT_mint}
//                                     onChange={(e) =>
//                                       handleAttributesChange(e, i)
//                                     }
//                                   />
//                                 </div>
//                                 <button
//                                   className="h-[35px] w-[35px] rounded-full font-bold bg-[#414e63] hover:bg-[#2C3B52]"
...
//                           <button
//                             className="mt-3 text-white font-semibold text-xl bg-[#414e63] hover:bg-[#2C3B52] w-[200px] h-[40px] rounded-full shadow-xl border uppercase"
...
//                           </label>
//                           {CSVfileName != "" && (
//                             <div className="mt-2">{CSVfileName}</div>
//                           )}
//                         </div>
//                       )}
//                     </div>
...
//                 {!isMigrating ? (
//                   <button
//                     className="mt-[30px] mx-auto text-white font-semibold text-xl bg-[#414e63] hover:bg-[#2C3B52] w-[160px] h-[35px] rounded-full shadow-xl border uppercase"
//                     onClick={migrate}
//                   >
//                     migrate
//                   </button>
...
//             </div>
//           </div>
//           {collectionNFTsuccess && (
//             <div className="mt-[1%]">
//               ✅ Collection NFT successfuly created!
//             </div>
//           )}
...
//           )}
//           {success && (
//             <div className="mt-[1%]">✅ NFT(s) successfuly migrated!</div>
//           )}
//           {error != "" && (
//             <div className="mt-[1%]">❌ Ohoh.. An error occurs: {error}</div>
//           )}
//         </div>
//       </div>
//     </div>
