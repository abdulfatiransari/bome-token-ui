...
//                   Send a NFT Message to the desired NFT, .sol domain name or <Link className="text-[#9B2DCA] underline" target="_blank" href="https://twitter.com/onsol_labs" rel="noreferrer">ANS</Link> owner
//                 </h1>
