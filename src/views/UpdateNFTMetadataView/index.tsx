...
//       if (newAnimationURI != "") {
//         newMetadata["animation_url"] =
//           newAnimationURI + "?ext=" + animationFormat;
...
//           for (let i = 0; i < currentfiles.length; i++) {
//             if (
//               currentfiles[i]["type"]?.includes("video/") ||
//               currentfiles[i]["type"]?.includes("model/")
//             ) {
//               newFiles.push(currentfiles[i]);
//             }
//           }
...
//         if (
//           attributesList[i]["trait_type"] != "" &&
//           attributesList[i]["value"] != ""
//         ) {
...
//                   <div className="flex">
//                     <button
//                       className="text-white font-semibold text-xl w-[6rem] h-[2rem] mt-2 mb-2 bg-[#2C3B52] hover:bg-[#566274] rounded-xl border"
//                       onClick={reset}
//                     >
//                       ← Back
//                     </button>
...
//                       <input
//                         className="mb-[1%] md:w-[480px] w-full h-[40px] text-center mx-4 text-black pl-1 border-2 border-black rounded-2xl"
//                         type="text"
//                         required
...
//                     <button
//                       className="text-white font-semibold text-xl bg-[#414e63] hover:bg-[#2C3B52] w-[160px] h-[35px] rounded-full shadow-xl border uppercase"
...
//                     ) : (
//                       <div className="text-white font-semibold text-3xl mb-5">
//                         You are not the update authority <br /> You can&apos;t
//                         update the following NFT
//                       </div>
//                     )}
...
//                         <div className="text-left font-bold text-sm md:text-lg underline ">
//                           Description
//                         </div>
...
//                   <div className="md:w-[600px] mx-auto">
//                     <div className="my-5 md:w-[600px] mx-auto font-semibold text-3xl">
...
//                         </div>
//                         <div>
//                           <label className="flex font-semibold text-lg">
//                             Format
//                           </label>
//                           <select
...
//                             onChange={(e) => setAnimationFormat(e.target.value)}
//                           >
//                             <option
//                               className="font-semibold text-lg"
//                               value="mp4"
...
//                       <div className="">
//                         <div className="mt-5 underline flex font-bold text-2xl">
//                           Attributes
//                         </div>
