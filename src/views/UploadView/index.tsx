...
//     const getUploadCost = await (
//       await metaplex.storage().getUploadPriceForFile(_file)
...
//                 <h1 className="mb-5 text-5xl">Upload File To Arweave</h1>
...
//                       You will upload <strong>{fileName}</strong> for{" "}
//                       {uploadCost} SOL
//                     </div>
//                   )}
...
//                     <button
//                       className="text-white font-semibold text-xl rounded-full shadow-xl bg-[#414e63] hover:bg-[#2C3B52] border w-[160px] h-[40px] mb-[3%] uppercase"
//                       onClick={UploadFile}
//                     >
//                       Upload
//                     </button>
...
//                   {uploading == true && (
//                     <button
//                       className="text-white font-semibold text-xl rounded-full shadow-xl bg-[#2C3B52] border w-[160px] h-[40px] mb-[3%] uppercase"
//                       onClick={UploadFile}
//                     >
//                       <svg
//                         role="status"
...
//                       Don&apos;t forget to copy the following link:
//                     </div>
//                   )}
//                   <div className="font-semibold text-xl underline">
//                     <Link target="_blank" rel="noreferrer" href={uri}>
//                       {" "}
//                       {uri}
//                     </Link>
//                   </div>
