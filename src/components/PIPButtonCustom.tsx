...
export const PIPButtonCustom: FC = ({}) => {
  ...
  return (
    <div>
      <button
        className="w-[169px] h-[50px] bg-[#1149ff] mb-[10px] hover:bg-[#0e3ed9] rounded-xl shadow-xl font-semibold text-lg"
          ...
          <div className="relative p-6 max-w-md h-full md:h-auto">
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center bg-[#15263F] shadow-xl rounded-xl">
                <label className="flex mb-[2px] font-semibold text-lg">
                  Select Currency
                </label>
                <select
                  className="mb-[10px] w-full text-black pl-1 border-2 border-black rounded-lg"
                  value={currency}
                  onChange={handleChange}
                >
                  <option className="font-semibold text-lg" value="SOL">
                    SOL
                  </option>
                  <option className="font-semibold text-lg" value="USDC">
                    USDC
                  </option>
                  <option className="font-semibold text-lg" value="PIP">
                    PIP
                  </option>
                  <option className="font-semibold text-lg" value="RAY">
                    RAY
                  </option>
                </select>
                ...
                {/* <div className="flex justify-center mt-[2px]">
                  <PIPButton
                    receiver="C6CPd7ZvfdCmmNEEchGrjLY39MeMN8AgwA7VTaMkWfer"
                    amount={tipAmount}
                    currency={currency}
                    label="SUPPORT US"
                ...
                {message != "" && <div className="mt-[5px]">{message}</div>}

                <div className="flex justify-center mt-[10px]">
                  <p className="text-xs font-semibold text-blac">Powered by </p>
                  <Link
                    target="_blank"
                    rel="noreferrer"
