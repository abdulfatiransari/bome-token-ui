    ...
    return (
        <div className='bg-[#121212] min-h-[100vh] '>
            ...
            <div className='mx-auto container flex flex-col justify-center items-center '>
                <h1 className='gradient-text text-[35px]'>Burn Solana SPL or LP Tokens</h1>
                <form
                    className="items-center flex flex-col w-full space-y-3 mt-5 mb-8 max-w-[300px]  "
                ...
                >
                    ...
                    {!isBurning ? (
                        ...
                        <button className="btn  w-full flex justify-center items-center  text-white">
                            <svg
                                role="status"
